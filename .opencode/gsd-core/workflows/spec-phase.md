...
```bash
INIT=$(node "C:/Users/tbc21/OneDrive/Desktop/Vasu/PERSONAL/client_dashboard/.opencode/gsd-core/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/tbc21/OneDrive/Desktop/Vasu/PERSONAL/client_dashboard/.opencode/gsd-core/templates/spec.md.
