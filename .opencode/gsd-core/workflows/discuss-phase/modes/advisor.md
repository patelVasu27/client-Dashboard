...
> `C:/Users/tbc21/OneDrive/Desktop/Vasu/PERSONAL/client_dashboard/.opencode/gsd-core/USER-PROFILE.md` exists). Skip the Read
...
```bash
PROFILE_CONTENT=$(cat "C:/Users/tbc21/OneDrive/Desktop/Vasu/PERSONAL/client_dashboard/.opencode/gsd-core/USER-PROFILE.md" 2>/dev/null || true)
```
...
2. For EACH user-selected gray area, spawn a `Agent()` in parallel:
   ...
   ```
   Agent(
     prompt="First, read @C:/Users/tbc21/OneDrive/Desktop/Vasu/PERSONAL/client_dashboard/.opencode/agents/gsd-advisor-researcher.md for your role and instructions.
