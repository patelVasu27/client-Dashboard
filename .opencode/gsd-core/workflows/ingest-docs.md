...
```bash
INIT=$(node "C:/Users/tbc21/OneDrive/Desktop/Vasu/PERSONAL/client_dashboard/.opencode/gsd-core/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/tbc21/OneDrive/Desktop/Vasu/PERSONAL/client_dashboard/.opencode/gsd-core/bin/gsd-tools.cjs" commit \
