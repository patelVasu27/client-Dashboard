...
- **Global scope**: `C:/Users/tbc21/OneDrive/Desktop/Vasu/PERSONAL/client_dashboard/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/tbc21/OneDrive/Desktop/Vasu/PERSONAL/client_dashboard/.opencode/notes/`)
...
2. Glob `C:/Users/tbc21/OneDrive/Desktop/Vasu/PERSONAL/client_dashboard/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/tbc21/OneDrive/Desktop/Vasu/PERSONAL/client_dashboard/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/tbc21/OneDrive/Desktop/Vasu/PERSONAL/client_dashboard/.opencode/notes/` — works in any directory
