...
The keys live in `.claude/settings.json` (project) or `C:/Users/tbc21/OneDrive/Desktop/Vasu/PERSONAL/client_dashboard/.opencode/settings.json` (global) — **not** in `.planning/config.json`:
